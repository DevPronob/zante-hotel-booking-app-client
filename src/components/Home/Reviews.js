...
const Reviews = () => {
  return (
    ...
    <div>
      <div class=" review__content mx-auto text-center md:max-w-xl lg:max-w-3xl  pt-12">
  <h3
...
<div class="review_grid grid gap-6 text-center lg:grid-cols-3 md:grid-cols-1 lg:gap-12 mb-[95px]">
  {/* <!-- First Testimonial --> */}
  <div class="mb-12 md:mb-0 review_item">
